...
namespace GazPromImport.Core.Services
{
    /// <summary>
    /// Логер приложения
    /// </summary>
    public static class ServiceLogger
    {
        ...
        public static void Debug(string perifix, string message, Exception exception = null, 
        ...
        /// <param name="exception"></param>
        /// <param name="extParams"></param>
        public static void Info(string perifix, String message, Exception exception = null, 
                                    Dictionary<String, Object> extParams = null) =>
        ...
        /// <param name="exception"></param>
        /// <param name="extParams"></param>
        public static void Warn(string perifix, String message, Exception exception = null, 
                                    Dictionary<String, Object> extParams = null) =>
        ...
        /// <param name="exception"></param>
        /// <param name="extParams"></param>
        public static void Error(string perifix, String message, Exception exception = null, 
                                    Dictionary<String, Object> extParams = null) =>
        ...
        /// <param name="exception"></param>
        /// <param name="extParams"></param>
        public static void Fatal(string perifix, String message, Exception exception = null, 
                                    Dictionary<String, Object> extParams = null) =>
        ...
        /// <param name="extParams"></param>
        /// <returns></returns>
        private static string MakeLogString(string prefix, string message, Exception exception = null, Dictionary<String, Object> extParams = null)
        {
            ...
            log.AppendFormat("{0}: {1}", prefix, message);
